    ...
    <div className="space-y-6">
      <Card className="relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-sm uppercase tracking-[0.3em] text-blue-200">AgentFlow-AI Showcase</div>
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            <Link href="/verification" className="rounded-full bg-white px-5 py-2 font-medium text-slate-950">运行验收中心</Link>
            <Link href="/dashboard" className="rounded-full border border-white/20 px-5 py-2 text-slate-200">进入控制台</Link>
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="mt-4 grid gap-3 text-sm text-slate-300 md:grid-cols-2">
          <div className="rounded-xl bg-white/10 p-4">不是单纯聊天 Demo，而是企业 AI 应用闭环。</div>
          <div className="rounded-xl bg-white/10 p-4">RAG 回答带引用来源，降低幻觉风险。</div>
          <div className="rounded-xl bg-white/10 p-4">Agent 工具调用链路可观察、可排查。</div>
          <div className="rounded-xl bg-white/10 p-4">Prompt、Eval、成本统计体现工程化思维。</div>
        </div>
      </Card>
    </div>
  );
