...
| Chat Streaming | 已支持 Provider SSE 基础链路与前端开关 | `/chat`、`POST /api/chat/completions/stream` |
| Knowledge / RAG | 已可演示 | `/knowledge` 上传 txt/md/pdf、问答、引用来源、删除文档 |
...
| Tool Audit | 已补齐前端筛选 | `/audit`、状态/工具/关键字筛选、`GET /api/audit/tools` |
